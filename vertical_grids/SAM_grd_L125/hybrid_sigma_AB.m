% hparish has written this routine to build the vertical grid and A,
% B coefficitents going into the level info in the nc file.

% To use, first create the single column level file (here it is
% './grd_31km_L125'), then run this m file and save the output in the nc
% file in the "file_name" varilble.

% More questions: email h.parish@uci.edu
...
zlev = load ('-ascii', './grd_31km_L125');   %reads in the interface height (m)
zlev = flipud (zlev);
...
file_name = 'hp_built_cam_levels_L125_c160302.nc';
