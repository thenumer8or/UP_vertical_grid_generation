...
% './grd_47km_L43'), then run this m file and save the output in the nc
...
zlev = load ('-ascii', './grd_47km_L143');   %reads in the interface height (m)
zlev = flipud (zlev);
...
file_name = 'hp_built_cam_levels_L143_c170614.nc';
