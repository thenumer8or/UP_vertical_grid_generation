...
Ain1   = ncread('../cami_0000-01-01_1.9x2.5_L30_c070703.nc', 'hyai');
Amn1   = ncread('../cami_0000-01-01_1.9x2.5_L30_c070703.nc', 'hyam');
Bin1   = ncread('../cami_0000-01-01_1.9x2.5_L30_c070703.nc', 'hybi');
Bmn1   = ncread('../cami_0000-01-01_1.9x2.5_L30_c070703.nc', 'hybm');
levn1  = ncread('../cami_0000-01-01_1.9x2.5_L30_c070703.nc', 'lev');
ilevn1 = ncread('../cami_0000-01-01_1.9x2.5_L30_c070703.nc', 'ilev');
...
nstart = 22; % top of the Sc layer around 800mb.
nstop  = 29; % bottom of the Sc layer around 970mb.
n      = 17; % produces 240 pressure levels total.
...
% file_name = 'custom_cami_0000-01-01_1.9x2.5_L120_Sc1_c150310.nc';
